...
def All_Initialization():
    ...
    st.image(image)
    st.markdown("<h1 style='text-align: center; color: #454545; font-size:25px;'>ChatGPT Application for Human Resource</h1><h2 style='text-align: center; color: blue; font-size:20px;'>ChatGPT Classifies Live Conversation by Hate, Insult, Threat, Obscene, and Profanity</h2>", unsafe_allow_html=True)
    st.markdown("""
