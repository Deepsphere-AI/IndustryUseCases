...
def Get_Chat_DMV_Input():
    ...
    with col2:
        ...
        vAR_st.write('')
        vAR_st.write('')
        vAR_st.subheader("Select Input (Voice&Text)")
        vAR_st.write('')
        vAR_st.write('')
    with col4:
        vAR_st.write('')
        vAR_st.write('')
        vAR_input_type = vAR_st.selectbox('',('Select Input','Text File','Audio File','Raw Conversational Text'))
        vAR_st.write('')
        vAR_st.write('')
